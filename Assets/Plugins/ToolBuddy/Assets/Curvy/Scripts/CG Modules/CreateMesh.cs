...
namespace FluffyUnderware.Curvy.Generator.Modules
{
    ...
    public class CreateMesh : ResourceExportingModule, ISerializationCallbackReceiver
    {
        ...
        [SerializeField]
        [Tooltip("Warning: this operation is Editor only (not available in builds) and CPU intensive.\nWhen combining multiple meshes, the UV2s are kept as is. Use this option to recompute them by uwrapping the combined mesh.")]
...
#if UNITY_EDITOR
        [FieldCondition(nameof(canUpdate), true, false, ConditionalAttribute.OperatorEnum.AND, "canGroupMeshes", true, false, Action = ConditionalAttribute.ActionEnum.Enable)]
#endif
        [SerializeField]
        ...
        /// <summary>
        /// Merge meshes sharing the same index
        /// </summary>
